      ...
      <div class="offset-1 me-3">
        ...
        <ul>
          <li>
            <div>
              Github -
              <a href="https://github.com/MuhamadGalangPriatama"> Muhamad Galang Priatama</a>
            </div>
          </li>
          <li>
          <div>
            Instagram -
            <a href="https://www.instagram.com/notamaezy?igsh=MXQ5ZjU4amV0emY4aA==">notamaezy</a>
          </div>
        </li>
          <li>
            <div>
              Email -
              <a href="mailto:muhamadgalangpriatama@gmail.com"> Muhamad Galang Priatama</a>
            </div>
          </li>
          <li>
            <div>
              WhatsApp -
              <a href="https://wa.me/+62895369461071">
                Klik Disini</a
              >
            </div>
          </li>
          <li>
            <div>
              LinkedIn -
              <a
                href="https://id.linkedin.com/in/muhamad-galang-priatama-412108302"
              >
                Muhamad Galang Priatama</a
              >
            </div>
          </li>
        </ul>
